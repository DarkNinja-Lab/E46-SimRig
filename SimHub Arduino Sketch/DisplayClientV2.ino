...
#define DEVICE_NAME "BMW E46 - Dash" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "36417486-1bdc-4624-a6c5-306a86447b86" //{"Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
